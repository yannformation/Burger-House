...
export default function LastProducts() {
  return (
    <Container>
      <div className="grid grid-rows-2 grid-cols-2 gap-x-9 gap-y-9 w-full h-96 px-11 my-19.5 text-white uppercase">

        <div className="row-span-2 relative bg-primary h-full rounded-md p-7">
