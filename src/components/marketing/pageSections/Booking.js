  ...
  return (
    <Container>
        <div className='relative mb-20'>
            ...
            <img src={Sauce} alt="Sauce Tabasco" className='absolute bottom-0 left-0' />
            <img src={Assiette} alt="Assiette avec un hamburger, des frites et du ketchup" className='absolute -bottom-52 -right-96' />
